...
// 2. AREA AUTENTIKASI (Tetap menyala untuk tes fitur Wisnu)
...
// Area Profil (Ini butuh auth karena mengambil data spesifik user)
...
// 3. AREA PENGENDARA (AUTH DIMATIKAN SEMENTARA)
Route::prefix('rider')->name('rider.')->group(function () {
    Route::resource('vehicles', VehicleController::class);
    Route::get('/peta', [SpkluController::class, 'index'])->name('map');
});

// 4. AREA VENDOR (AUTH DIMATIKAN SEMENTARA)
...
// 5. AREA ADMIN (AUTH DIMATIKAN SEMENTARA)
