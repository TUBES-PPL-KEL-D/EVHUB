    ...
    <div class="vendor-scope" style="color: #0f172a;">
        ...
        <div class="overflow-hidden rounded-3xl bg-white shadow-sm ring-1 ring-slate-200">
            <div class="border-b border-slate-200 bg-gradient-to-r from-emerald-600 to-emerald-500 px-6 py-6 text-slate-900">
                <h1 class="mt-2 text-3xl font-bold text-slate-900">Dokumen Legalitas Vendor</h1>
                <p class="mt-2 text-slate-700">Dokumen berhasil tersimpan dan sedang menunggu proses berikutnya.</p>
            </div>
            ...
            <div class="grid gap-6 px-6 py-6 md:grid-cols-2">
                ...
                <div class="rounded-2xl bg-slate-50 p-5">
                    <p class="text-sm font-semibold text-slate-700">Status Registrasi</p>
                ...
                <div class="rounded-2xl bg-slate-50 p-5 md:col-span-2">
                    <p class="text-sm font-semibold text-slate-700">File Dokumen</p>
            ...
            <div class="flex flex-col gap-3 border-t border-slate-200 px-6 py-5 sm:flex-row sm:items-center sm:justify-between">
                <p class="text-sm font-medium text-slate-600">Vendor dapat melanjutkan ke proses review berikutnya.</p>
