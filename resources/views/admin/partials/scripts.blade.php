...
<script>
    ...
    function openTicketModal(btn) {
        ...
        setTimeout(() => { 
            ...
            document.getElementById('ticketModalContent').classList.remove('scale-95'); 
        }, 10);
    }
    ...
    function closeTicketModal() {
        ...
        document.getElementById('ticketModalContent').classList.add('scale-95');
        setTimeout(() => { 
    ...
    function closeReviewModal() {
        const modal = document.getElementById('reviewModal');
        modal.classList.add('opacity-0'); 
        document.getElementById('reviewModalContent').classList.add('scale-95');
        setTimeout(() => { 
            modal.classList.add('hidden'); 
            modal.classList.remove('flex'); 
