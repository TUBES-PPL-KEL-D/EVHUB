...
<div class="max-w-6xl mx-auto space-y-8">
    ...
    <div>
        <h2 class="text-2xl font-bold text-slate-800 mb-6 flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14M8 20h8a2 2 0 002-2V6a2 2 0 00-2-2H8a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
            Galeri Foto Stasiun
        </h2>
        ...
        @if($spklu->galleryPhotos->isEmpty())
            <div class="bg-white rounded-xl border border-slate-100 p-8 text-center text-slate-500 shadow-sm">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 mx-auto text-slate-300 mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14" /></svg>
                <p>Belum ada foto galeri untuk SPKLU ini.</p>
            </div>
        @else
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                @foreach($spklu->galleryPhotos as $photo)
                    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                        ...
                        @if($photo->caption)
                            <div class="p-4">
                                <p class="text-sm text-slate-600">{{ $photo->caption }}</p>
                            </div>
                        @endif
                    </div>
                @endforeach
