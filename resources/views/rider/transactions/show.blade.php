...
@php
    $estimatedMinutes = 0;
    if ($transaction->chargerMachine && $transaction->chargerMachine->capacity_kw > 0 && $transaction->energy_consumed > 0 ) {
        ...
        <div class="py-6 space-y-4 text-sm border-b border-slate-800/80">
            ...
            <div class="flex justify-between">
                ...
                <span class="text-white font-medium">
                    {{ $transaction->finished_at ? $transaction->finished_at->format('d F Y, H:i') : $transaction->created_at->format('d F Y, H:i') }} WIB
                </span>
            </div>
            ...
            <div class="flex justify-between">
                ...
                <span class="text-white font-medium">
                    {{ $transaction->chargerMachine->name }} ({{ $transaction->chargerMachine->connector_type }})
                </span>
            </div>
            <div class="flex justify-between">
